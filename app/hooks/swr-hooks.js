...
export function useMarket(pageIndex) {
  const { data, error, isLoading } = useSwr(
    `https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&order=market_cap_desc&per_page=25&page=${pageIndex}&sparkline=true&price_change_percentage=1h%2C24h%2C7d&locale=en
    `,
    fetcher
  );
